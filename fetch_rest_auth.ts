...
const apiKey = "AIzaSyAk1PLI7PdZgc7zA05ZN9sxcgKM-xhNhxI";
const url = `https://firestore.googleapis.com/v1/projects/${projectId}/databases/${databaseId}/documents/forklifts?key=${apiKey}`;
...
https.get(url, (res) => {
  ...
  res.on('end', () => {
    try {
      ...
      console.log(`Total documents: ${json.documents.length}`);
